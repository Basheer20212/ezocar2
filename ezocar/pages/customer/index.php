...
<body>
    <div class="fullPage">
            ...
            <div class="loginPage" id="loginForm">
                <div class="formBox">
                    <a href="" style="font-size:50px;padding:0">Ezocar</a>
                    ...
                    <form class="inputGroupRegister" id="register" action="" method="POST">
                    ...
                    <input style="margin:5px auto 0px 0px" type="text" name="email"class="inputField" placeholder="Email Id" required>
                    <input style="margin:5px auto 0px 0px" type="password1" name="password"class="inputField" placeholder="Enter Password" required>
                    <input style="margin:5px auto 0px 0px" type="password" class="inputField" placeholder="Confirm Password" required>
